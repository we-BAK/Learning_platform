...
export default function Features() {
  ...
  return (
    <section className="py-20 bg-gradient-to-br from-blue-50 via-white to-indigo-50 text-gray-900">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="text-center mb-16">
          ...
          >
            What Makes <span className="text-blue-600">Bright Connect</span> Shine?
          </motion.h2>
          <motion.p 
          ...
          >
            Our platform is built with families in mind, offering powerful features designed to simplify communication and enhance the therapy journey.
          </motion.p>
